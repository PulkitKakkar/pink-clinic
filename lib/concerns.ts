...
export const beautyServiceAreas: BeautyServiceArea[] = [
  {
    slug: "face-skin",
    name: "Face & skin",
    description: "Facials, peels, skin quality and complexion treatments.",
    terms: ["facial", "peel", "skin", "hydra", "dermaplaning", "microdermabrasion", "morpheus", "cosmelan"],
  },
  {
    slug: "eyes-lips-brows",
    name: "Eyes, lips & brows",
    description: "Eye-area care, brows, lashes, lip treatments and makeup.",
    terms: ["eye", "brow", "eyelash", "lash", "lip", "makeup"],
  },
  {
    slug: "hair-scalp",
    name: "Hair & scalp",
    description: "Hair reduction, hair restoration, colour, cuts and styling.",
    terms: ["hair", "scalp", "balayage", "blow dry"],
  },
  {
    slug: "body-contouring",
    name: "Body & contouring",
    description: "Targeted body treatments, shaping and skin maintenance.",
    terms: ["body", "lemon bottle", "contour", "massage", "back"],
  },
  {
    slug: "hands-feet",
    name: "Hands & feet",
    description: "Manicures, pedicures, nail finishes and maintenance.",
    terms: ["nail", "manicure", "pedicure", "shellac", "feet", "hand"],
  },
  {
    slug: "intimate-piercing",
    name: "Intimate areas & piercing",
    description: "Specialist waxing, intimate treatments and piercing.",
    terms: ["intimate", "bikini", "brazilian", "hollywood", "piercing"],
  },
];
