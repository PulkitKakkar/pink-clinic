...
const laserDevice: ConsultationTemplate = {
  ...
  conditionalRequirements: [
    ...
    { whenField: "otherMedication", values: ["Yes"], requiredField: "otherMedicationDetails", message: "Add the medication details." },
    { whenField: "recentSurgery", values: ["Yes"], requiredField: "surgeryDetails", message: "Add the surgery details." },
    { whenField: "previousLaserHairRemoval", values: ["Yes"], requiredField: "previousLaserDetails", message: "Add when and where the previous laser hair removal took place." },
    { whenField: "otherCosmeticProcedure", values: ["Yes"], requiredField: "cosmeticProcedureDetails", message: "Add the cosmetic procedure details." },
  ],
  ...
  sections: [
    details([f("homeTelephone", "Home telephone", "tel"), options("areasToTreat", "Areas to be treated", ["Face", "Upper lip", "Chin", "Jawline", "Neck", "Underarms", "Arms", "Hands / fingers", "Chest", "Abdomen", "Back", "Bikini line", "Brazilian", "Hollywood", "Buttocks", "Legs", "Feet / toes", "Other"], true), f("otherTreatmentArea", "Other treatment area", "text")]),
    ...
    { title: "Skin Type Analysis — Genetic Disposition", description: "Enter the score matching the client's natural characteristics.", fields: [
      { id: "eyeColourScore", label: "Colour of eyes", type: "select", options: [score("0", "Light blue, grey or green"), score("1", "Blue, grey or green"), score("2", "Blue"), score("3", "Dark brown"), score("4", "Brownish black")] },
      { id: "naturalHairColourScore", label: "Natural hair colour", type: "select", options: [score("0", "Sandy red"), score("1", "Blond"), score("2", "Chestnut / dark blond"), score("3", "Dark brown"), score("4", "Black")] },
      { id: "unexposedSkinColourScore", label: "Skin colour on non-exposed areas", type: "select", options: [score("0", "Reddish"), score("1", "Very pale"), score("2", "Pale with beige tint"), score("3", "Light brown"), score("4", "Dark brown")] },
      { id: "frecklesScore", label: "Freckles on unexposed areas", type: "select", options: [score("0", "Many"), score("1", "Several"), score("2", "Few"), score("3", "Incidental"), score("4", "None")] },
      f("geneticDispositionScore", "Genetic Disposition score", "number"),
    ]},
    { title: "Skin Type Analysis — Reaction to Sun Exposure", fields: [
      { id: "sunReactionScore", label: "Skin reaction if in the sun too long", type: "select", options: [score("0", "Painful redness, blistering, peeling"), score("1", "Blistering followed by peeling"), score("2", "Burns, sometimes followed by peeling"), score("3", "Rare burns"), score("4", "Never had burns")] },
      { id: "tanDegreeScore", label: "Degree of tan", type: "select", options: [score("0", "Hardly or not at all"), score("1", "Light colour tan"), score("2", "Reasonable tan"), score("3", "Tan very easily"), score("4", "Turn dark brown quickly")] },
      { id: "brownWithinHoursScore", label: "Turn brown within several hours after sun exposure", type: "select", options: [score("0", "Never"), score("1", "Seldom"), score("2", "Sometimes"), score("3", "Often"), score("4", "Always")] },
      { id: "faceSunReactionScore", label: "Face reaction to the sun", type: "select", options: [score("0", "Very sensitive"), score("1", "Sensitive"), score("2", "Normal"), score("3", "Very resistant"), score("4", "Never had a problem")] },
      f("sunExposureReactionScore", "Reaction to Sun Exposure score", "number"),
    ]},
    { title: "Skin Type Analysis — Tanning Habits and Result", fields: [
      { id: "lastTanScore", label: "When did the treatment area last receive a tan?", type: "select", options: [score("0", "More than 3 months ago"), score("1", "2–3 months ago"), score("2", "1–2 months ago"), score("3", "Less than a month ago"), score("4", "Less than 2 weeks ago")] },
      { id: "sunExposureFrequencyScore", label: "How often is the treatment area exposed to the sun?", type: "select", options: [score("0", "Never"), score("1", "Hardly ever"), score("2", "Sometimes"), score("3", "Often"), score("4", "Always")] },
      f("tanningHabitsScore", "Tanning Habits score", "number"), f("skinTypeTotalScore", "Skin Type total score", "number"),
      { id: "fitzpatrickType", label: "Fitzpatrick skin type", type: "select", options: [
