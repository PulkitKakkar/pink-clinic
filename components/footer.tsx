...
export function Footer() {
  return (
    <footer className="bg-[#16010d] py-10 text-white sm:py-16">
      ...
      <div className="container-site mt-8 flex flex-col gap-2 border-t border-white/10 pt-5 text-[10px] text-white/35 sm:mt-14 sm:flex-row sm:justify-between sm:pt-7 sm:text-xs"><p>© {new Date().getFullYear()} Pink Beauty Salon & Academy.</p><p>v{appVersion} · Beauty. Confidence. Success.</p></div>
    </footer>
  );
}
