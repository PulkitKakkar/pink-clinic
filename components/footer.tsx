  ...
  return (
    <footer className="bg-[#16010d] py-10 text-white sm:py-16">
      <div className="container-site grid gap-8 sm:gap-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div><p className="text-xs font-bold uppercase tracking-[.2em] text-pink">Explore</p><div className="mt-5 grid gap-3 text-sm text-white/65"><Link href="/products-services">Treatments</Link><Link href="/courses">Academy courses</Link><Link href="/gallery">Gallery</Link><Link href="/#reviews">Reviews</Link><Link href="/contact">Contact</Link></div></div>
