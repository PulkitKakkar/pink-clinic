...
export function PublicChrome({ children, offers }: { children: React.ReactNode; offers: Promotion[] }) {
  ...
  const isWorkspace = pathname.startsWith("/admin") || pathname === "/learner-login" || pathname.startsWith("/learners") || pathname === "/studio-login" || pathname === "/studio" || pathname.startsWith("/studio/");
