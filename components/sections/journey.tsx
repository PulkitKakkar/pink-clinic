...
const cards = [
  { title: "Treatments", href: "/products-services", description: "Advanced beauty and aesthetic treatments designed to help you look and feel your best.", image: "/images/photoshoot/treatments.jpg", label: "Explore treatments", number: "01" },
  { title: "Courses", href: "/courses", description: "Professional beauty training and accredited courses for the next generation of specialists.", image: "/images/photoshoot/courses.jpg", label: "Explore courses", number: "02" },
];
