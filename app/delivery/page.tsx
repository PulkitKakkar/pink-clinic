...
export default function DeliveryPage() {
  return <PolicyPage eyebrow="Physical products" title="Delivery." intro="Delivery information applies only where a physical product is offered for shipment." sections={[
    ...
    { title: "Questions or delays", body: "Contact the branch shown on your order confirmation if a parcel is delayed or arrives damaged. West Street: info@pinkbeautysalons.co.uk or 0118 996 2711. Watlington Street: pinkclinicreading@gmail.com or 0118 402 8505." },
  ]} />;
}
