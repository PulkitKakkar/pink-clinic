...
export default function DeliveryPage() {
  return <PolicyPage eyebrow="Physical products" title="Delivery." intro="This delivery information applies to physical products sold for shipment by Pink Beauty Salon & Academy or Pink Beauty Clinic." sections={[
    ...
    { title: "Questions or delays", body: "Contact the business shown on your order confirmation if a parcel is delayed or arrives damaged. Pink Beauty Salon & Academy: info@pinkbeautysalons.co.uk or 0118 996 2711. Pink Beauty Clinic: pinkbeautyreading@gmail.com or 0118 402 8505." },
  ]} />;
}
