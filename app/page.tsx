...
export default function Home() {
  ...
  return <main><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} /><Hero /><PinkStory /><OffersCarousel offers={offers} /><WhyPink /><Team /><ServicesShowcase /><Reviews /><InstagramFeed /><AppointmentCta /></main>;
}
